...
public class ZMartKafkaStreamsApp {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // rewardsKStream
        KStream<String, RewardAccumulator> rewardsKStream = purchaseKStream.mapValues(
            purchase -> RewardAccumulator.builder(purchase).build());
